        ...
        <div class="card mb-4">
          ...
          <div class="card-header py-0 d-flex justify-content-between">
            ...
            <a href="#mymodal"
               ...
               data-remote="{{ route('staff.create') }}"
               data-toggle="modal"
               data-target="#mymodal"
                ...
                <table class="table align-items-center mb-0" id="myTable">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Staff</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kantor</th>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-3 py-1">
                            <div class="form-check">
                              <input class="form-check-input checkbox" type="checkbox" id="checkall" name="ids[{{ $staff->id }}]" value="{{ $staff->id }}">
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="d-flex px-3 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              ...
                              <p class="text-xs text-secondary mb-0">{{ $staff->position->name }}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="d-flex px-3 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{ $staff->office->name }}</h6>
                              <p class="text-xs text-secondary mb-0">{{ $staff->office->indoCity->name }}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="d-flex px-3 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{ $staff->shift->shift_name }}</h6>
                          </div>
                          </div>
                        </td>
                        <td class="align-middle">
                          <a href="#mymodal" 
                             ...
                             data-remote="{{ route('staff.edit', $staff->id) }}"
                             data-toggle="modal"
                             data-target="#mymodal"
                             data-title="Ubah Data Staff"
                          >
                            <i class="fas fa-pen"></i>
                          </a>
                          <a href="#mymodal"
                             class="text-info font-weight-bold text-sm px-3" 
                             data-remote="{{ route('staff.show', $staff->id) }}"
                             data-toggle="modal"
                             data-target="#mymodal"
                             data-title="Info Data Staff"
                          >
                            <i class="fas fa-eye"></i>
                          </a>  
                          <a href="{{ route('staff.confirmation', $staff->id) }}"
